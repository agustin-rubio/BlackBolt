            ...
            <div class="accordion-item">
              ...
              <div id="collapseTwo" class="accordion-collapse collapse" aria-labelledby="headingTwo" data-bs-parent="#accordionExample">
                <div class="accordion-body">
                  <strong>3 cuotas sin interés de $${elementoFiltrado2.precio_unitario / 3}</strong> CFT: 0,00% - Total: $${elementoFiltrado2.precio_unitario} <br> En 1 pago: $${elementoFiltrado2.precio_unitario}
                </div>
              </div>
            </div>
            <div class="accordion-item">
