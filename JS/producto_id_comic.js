  ...
  return  `<div class = "contenedor-detalle-producto1">
    <div class="card mb-3 mx-auto" style="max-width: 1540px;">
      <div class="row g-0">
        ...
        <div class="col-md-8">
          <div class="card-body ">
            <h2 class="card-title">${elementoFiltrado1.nombre}</h2>
            <p class="card-text precio">$${elementoFiltrado1.precio_unitario}</p>
            <img src="../../img/producto/credit-card.svg"> 3 cuotas <strong>sin interés</strong> de $${elementoFiltrado1.precio_unitario / 3}</img>
            ...
            <div class="accordion-item">
              ...
              <div id="collapseTwo" class="accordion-collapse collapse" aria-labelledby="headingTwo" data-bs-parent="#accordionExample">
                <div class="accordion-body">
                  <strong>3 cuotas sin interés de $${elementoFiltrado1.precio_unitario / 3}</strong> CFT: 0,00% - Total: $${elementoFiltrado1.precio_unitario} <br> En 1 pago: $ ${elementoFiltrado1.precio_unitario}
                </div>
              </div>
            </div>
            <div class="accordion-item">
